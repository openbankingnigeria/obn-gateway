...
export const COLLECTION_ACTIONS_CONSUMER_DATA = [
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M8.00027 9.99967C9.10484 9.99967 10.0003 9.10424 10.0003 7.99967C10.0003 6.89511 9.10484 5.99967 8.00027 5.99967C6.8957 5.99967 6.00027 6.89511 6.00027 7.99967C6.00027 9.10424 6.8957 9.99967 8.00027 9.99967Z"
          stroke="#344054"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export const COLLECTION_ACTIONS_DATA = [
  ...
  // },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M4.66683 11.3332H11.3335C13.1744 11.3332 14.6668 9.84079 14.6668 7.99984C14.6668 6.15889 13.1744 4.6665 11.3335 4.6665H4.66683M4.66683 11.3332C2.82588 11.3332 1.3335 9.84079 1.3335 7.99984C1.3335 6.15889 2.82588 4.6665 4.66683 4.6665M4.66683 11.3332C6.50778 11.3332 8.00016 9.84079 8.00016 7.99984C8.00016 6.15889 6.50778 4.6665 4.66683 4.6665"
          fill="transparent"
          stroke="#344054"
          strokeWidth="1.5"
          strokeLinecap="round"
...
export const COLLECTIONS_TABLE_FULLDATA = [
  {
    ...
    description:
      "Authorization in Open banking could be perform using smart channel, for customers with access to smart devices.",
    no_of_apis: "9",
    configuration: "9",
  },
  {
    ...
    description:
      "These endpoints provide information about functions and services that are available from an API Provider. These would be available to API Consumers to make programmatic decisions which of the services can be made available to End Users.",
    no_of_apis: "7",
    configuration: "7",
  },
  {
    ...
    description:
      "The endpoints are used to create a customer at the bank. The customer's detail supplied belongs exclusive to the bank where it is being created. The section also provides api that could be used to manage a customer.",
    no_of_apis: "7",
    configuration: "7",
  },
  {
  ...
  },
  {
    ...
    description:
      "Virtual Accounts help merchants or service providers to create accounts on the fly to receive payments, which are then instantly mapped to their collection accounts and reconciled to their customers. Virtual Accounts can be mapped to a Customer on a service providers platform or to a particular order.",
    no_of_apis: "5",
    configuration: "5",
  },
  {
    ...
    description:
      "This endpoint is used to report fraud incidences directly to the bank or financial institution. It may sometimes be difficult to get account holders authenticated therefore identifying information are not mandatory. However, banks may not process these requests online real time and its for informational purposes only",
    no_of_apis: "2",
    configuration: "2",
  },
  {
