...
const CoreBanking = () => {
  ...
  const registry = EXTERNAL_SERVICES_DATA({
    ...
    urlDescription: 'The address where the Core Banking can be accessed.',
    apiKeyDescription: 'The API key to authenticate access to the Core Banking features and data.'
  });
