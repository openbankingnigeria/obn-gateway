...
const BillsPayments = () => {
  ...
  const registry = EXTERNAL_SERVICES_DATA({
    ...
    urlDescription: 'The address where the Bills Payments service can be accessed.',
    apiKeyDescription: 'The API key to authenticate access to the Bills Payments features and data.'
  });
