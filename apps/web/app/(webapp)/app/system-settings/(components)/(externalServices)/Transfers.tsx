...
const Transfers = () => {
  ...
  const registry = EXTERNAL_SERVICES_DATA({
    ...
    urlDescription: 'The address where the Transfers service can be accessed.',
    apiKeyDescription: 'The API key to authenticate access to the Transfers service features and data.'
  });
