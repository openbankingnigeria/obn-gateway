...
const DirectDebit = () => {
  ...
  const registry = EXTERNAL_SERVICES_DATA({
    ...
    urlDescription: 'The address where the Direct Debit service can be accessed.',
    apiKeyDescription: 'The API key to authenticate access to the Direct Debit service\'s features and data.'
  });
