...
const Cards = () => {
  ...
  const registry = EXTERNAL_SERVICES_DATA({
    ...
    urlDescription: 'The address where the Cards service can be accessed.',
    apiKeyDescription: 'The API key to authenticate access to the Cards service\'s features and data.'
  });
