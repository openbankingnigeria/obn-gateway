...
const ConsumerSections = ({
  ...
  let assignPermit = findPermissionSlug(
    userPermissions,
    "assign-api-endpoints"
  );

  const enabledConsumer =
    altData?.status == "active" && altData?.kybStatus == "approved";
  ...
  const getAction = () => {
    return actions.filter((action) => {
      return action?.type == "all" && action?.name != "delete";
    });
  };
  ...
  const handleApiModification = async (
    /* code: string, */ e?: FormEvent<HTMLFormElement>
  ) => {
    e && e.preventDefault();
    ...
    cell: ({ row }) => (
      <div id={row.original.id} className="relative block">
        ...
        >
          ...
          >
            <path
              d="M10.5001 10.8335C10.9603 10.8335 11.3334 10.4604 11.3334 10.0002C11.3334 9.53993 10.9603 9.16683 10.5001 9.16683C10.0398 9.16683 9.66675 9.53993 9.66675 10.0002C9.66675 10.4604 10.0398 10.8335 10.5001 10.8335Z"
              fill="transparent"
              stroke="#666D80"
              strokeWidth="2"
              strokeLinecap="round"
            ...
            />
            <path
              d="M10.5001 5.00016C10.9603 5.00016 11.3334 4.62707 11.3334 4.16683C11.3334 3.70659 10.9603 3.3335 10.5001 3.3335C10.0398 3.3335 9.66675 3.70659 9.66675 4.16683C9.66675 4.62707 10.0398 5.00016 10.5001 5.00016Z"
              fill="transparent"
              stroke="#666D80"
              strokeWidth="2"
              strokeLinecap="round"
            ...
            />
            <path
              d="M10.5001 16.6668C10.9603 16.6668 11.3334 16.2937 11.3334 15.8335C11.3334 15.3733 10.9603 15.0002 10.5001 15.0002C10.0398 15.0002 9.66675 15.3733 9.66675 15.8335C9.66675 16.2937 10.0398 16.6668 10.5001 16.6668Z"
              fill="transparent"
              stroke="#666D80"
              strokeWidth="2"
              strokeLinecap="round"
